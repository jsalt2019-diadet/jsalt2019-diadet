...
score_babytrain_dir=exp/diarization/$nnet_name/$be_diar_babytrain_enhanced_name
score_chime5_dir=exp/diarization/$nnet_name/$be_diar_chime5_enhanced_name
score_ami_dir=exp/diarization/$nnet_name/$be_diar_ami_enhanced_name
score_sri_dir=$score_chime5_enhanced_dir
...
dsets_spkdiar_dev_enhanced_evad=(jsalt19_spkdiar_babytrain_enhanced_dev jsalt19_spkdiar_chime5_enhanced_dev_{U01,U06} jsalt19_spkdiar_ami_enhanced_dev_{Mix-Headset,Array1-01,Array2-01})
dsets_spkdiar_dev_enhanced_gtvad=(jsalt19_spkdiar_babytrain_enhanced_dev_gtvad jsalt19_spkdiar_chime5_enhanced_dev_{U01,U06}_gtvad jsalt19_spkdiar_ami_enhanced_dev_{Mix-Headset,Array1-01,Array2-01}_gtvad)
...
# TESTING(FIXME)
dsets_dev=(${dsets_spkdiar_dev_evad[@]} ${dsets_spkdiar_dev_enhanced_evad[@]} ${dsets_spkdiar_dev_enhanced_gtvad[@]})
dsets_eval=(${dsets_spkdiar_eval_evad[@]} ${dsets_spkdiar_eval_enhanced_evad[@]} ${dsets_spkdiar_eval_enhanced_gtvad[@]})
dsets_test="${dsets_dev[@]} ${dsets_eval[@]}"
