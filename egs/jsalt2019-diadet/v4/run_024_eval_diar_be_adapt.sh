...
#dsets_spkdet_dev_evad=(jsalt19_spkdet_{babytrain,ami,sri}_dev_test jsalt19_spkdet_{sri,babytrain}_dev_test_overlap)
dsets_spkdet_dev_evad=(jsalt19_spkdet_{sri,babytrain}_dev_test_overlap)
