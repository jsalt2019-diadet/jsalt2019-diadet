...
local/make_table_line_spkdiar_jsalt19_chime5_enhanced.sh "$name e-vad speech-enhanced" $score_dir
local/make_table_line_spkdiar_jsalt19_chime5_enhanced.sh "$name_adapt_enh e-vad speech-enhanced" $score_adapt_enh_dir
