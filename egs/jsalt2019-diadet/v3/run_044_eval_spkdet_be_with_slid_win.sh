...
score_plda_dir=$score_dir/plda_slid_win_w${window}_s${period}
score_plda_adapt_dir=$score_dir/plda_adapt_slid_win_w${window}_s${period}
score_plda_adapt_snorm_dir=$score_dir/plda_adapt_snorm_slid_win_w${window}_s${period}
...
if [ $stage -le 2 ];then
    ...
    for plda in plda_slid_win_w${window}_s${period} plda_adapt_slid_win_w${window}_s${period}
	do
